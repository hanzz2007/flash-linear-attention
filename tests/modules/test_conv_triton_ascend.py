...
from tests.modules.conv_ascend_cases import CONV_DENSE_CASES, CONV_VARLEN_CASES, ConvDenseCase, ConvVarlenCase
...
def test_dense_precision_selector(monkeypatch):
    """The active acceptance mode remains high precision."""
    ...
    monkeypatch.delenv("FLA_ASCEND_CONV_PRECISION", raising=False)
